  ...
  fr: {
    ...
    admin: {
      ...
      importer: {
        ...
        hint: "Colle le lien d'une opportunité : l'IA lit la page et pré-remplit le formulaire. Vérifie ensuite les champs avant d'enregistrer.",
        urlPlaceholder: "https://… (lien de l'opportunité)",
        button: 'Analyser le lien',
  ...
  en: {
    ...
    admin: {
      ...
      importer: {
        ...
        hint: 'Paste an opportunity link: the AI reads the page and pre-fills the form. Review every field before saving.',
